package com.example.edu_sale.presentation
...
import com.example.courses.CoursesScreen
import com.example.edu_sale.R
import com.example.favorites.FavoriteScreen
...
fun MainScreenWrapper(onLogout: () -> Unit) {
    ...
    val navigationItems = listOf(
        NavigationItem(stringResource(R.string.nav_home), Icons.Outlined.Home, Icons.Filled.Home, "0"),
        NavigationItem(stringResource(R.string.nav_favorites), Icons.Outlined.BookmarkBorder, Icons.Filled.BookmarkBorder, "1"),
        NavigationItem(stringResource(R.string.nav_account), Icons.Outlined.AccountCircle, Icons.Filled.AccountCircle, "2")
    )
